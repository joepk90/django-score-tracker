"""
Django settings for score_tracker project.
...
ALLOWED_HOSTS = []
ALLOWED_HOSTS_ENV_VAR = os.environ.get("ALLOWED_HOSTS", None)
if (ENVIRONMENT == 'DEV'):
    ALLOWED_HOSTS = ['*']
elif ALLOWED_HOSTS_ENV_VAR is not None:
...
ROOT_URLCONF = 'score_tracker.urls'
...
WSGI_APPLICATION = 'score_tracker.wsgi.application'
